...
1. [Deleting at given position](https://www.geeksforgeeks.org/problems/delete-a-node-in-single-linked-list/1)
2. [Kth from End of Linked List](https://www.geeksforgeeks.org/problems/nth-node-from-end-of-linked-list/1)
3. [Remove every k-th node of the linked list](https://www.geeksforgeeks.org/problems/remove-every-kth-node/1)
